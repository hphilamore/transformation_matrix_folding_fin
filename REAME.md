...
A wireframe model of the folded fin was generated by drawing each hinge, to connects each joint $q$, to the fin base, $FB$ where the position (3D coordinates) of $FB$ are the a three-vector $\mathbf{p}^i_{i+1}$ found by:
